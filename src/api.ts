...
export async function fetchInterestingImages(limit: number = 50): Promise<ApiResponse> {
...
export async function fetchWebcamImagesByDays(days: number, limit: number = 50): Promise<ApiResponse> {
